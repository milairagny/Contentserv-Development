...
<section class="footer-section">
	<div class="container grid-x grid-margin-x">
		...
		<div class="links-social-container grid-x grid-margin-x">
...
<?php endwhile ?>
		...
		<div class="newsletter-container grid-x grid-margin-x" data-equalizer>
		...
		<div class="copyright-container grid-x grid-margin-x">
			<div class="large-3 cell">
